...
-------
    ...
    ./src/ucacoind -daemon # Starts the ucacoin daemon.
    ./src/ucacoin-cli --help # Outputs a list of command-line options.
    ./src/ucacoin-cli help # Outputs a list of RPC commands when the daemon is running.
