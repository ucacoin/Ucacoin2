...
The script [extract-osx-sdk.sh](https://github.com/ucacoin-project/ucacoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ucacoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ucacoin-project/ucacoin/blob/master/doc/README_osx.md) for troubleshooting tips.
