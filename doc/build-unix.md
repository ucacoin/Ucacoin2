UNIX BUILD NOTES
====================
Some notes on how to build UCACoin in Unix.

Note
---------------------
Always use absolute paths to configure and compile UCACoin and the dependencies,
...
memory available when compiling UCACoin. On systems with less, gcc can be
...
To build UCACoin without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your UCACoin installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, UCACoin should be built with a non-executable stack
