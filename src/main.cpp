...
/** Fees smaller than this (in uuca) are considered zero fee (for relaying, mining and transaction creation)
...
bool IsSkippingRange(int nHeight) {
	if ((nHeight > 549990 && nHeight < 550120) || (nHeight > 649990 && nHeight < 650120)
