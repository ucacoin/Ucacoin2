...
#include "qt/ucacoin/coldstakingwidget.h"
#include "qt/ucacoin/forms/ui_coldstakingwidget.h"
#include "qt/ucacoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/ucacoin/requestdialog.h"
#include "qt/ucacoin/tooltipmenu.h"
#include "qt/ucacoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(ucacoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your UCAs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept UCA delegation / Delegate UCA"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select UCA outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 UCA" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
