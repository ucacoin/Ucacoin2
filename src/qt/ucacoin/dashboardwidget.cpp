	...
	ui(new Ui::DashboardWidget)
{
	...
	// Staking Information
	ui->labelMessage->setText(tr("Amount of UCA staked."));
	setCssSubtitleScreen(ui->labelMessage);
	setCssProperty(ui->labelSquareUca, "square-chart-uca");
	setCssProperty(ui->labelUca, "text-chart-uca");
	...
	ui->labelAmountUca->setText("0 UCA");
	...
	ui->btnHowTo->setText(tr("How to get UCA"));
...
void DashboardWidget::onChartRefreshed() {
	...
	// init sets
	set0 = new QBarSet("UCA");
	set0->setColor(QColor(127, 115, 76));
