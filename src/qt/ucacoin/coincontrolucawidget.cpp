...
#include "qt/ucacoin/coincontrolucawidget.h"
#include "qt/ucacoin/forms/ui_coincontrolucawidget.h"

CoinControlUcaWidget::CoinControlUcaWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlUcaWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select UCA Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("UCA");
    ...
    ui->labelValueAfter->setText("0.00 UCA");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 UCA");
    ui->labelValueFee->setText("0.00 UCA");
...
CoinControlUcaWidget::~CoinControlUcaWidget()
{
    delete ui;
}
