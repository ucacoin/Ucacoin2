...
#include "qt/ucacoin/receivewidget.h"
#include "qt/ucacoin/forms/ui_receivewidget.h"
...
ReceiveWidget::ReceiveWidget(ucacoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive UCA."));
