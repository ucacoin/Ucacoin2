...
#include "qt/ucacoin/topbar.h"
#include "qt/ucacoin/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/ucacoin/lockunlock.h"
#include "qt/ucacoin/qtutils.h"
#include "qt/ucacoin/receivedialog.h"
...
TopBar::TopBar(ucacoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel() {
    ...
    // update the display unit, to not use the default ("ucacoin")
    updateDisplayUnit();
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // UCA Total
    CAmount ucaAvailableBalance = balance;
    // Set
    QString totalUca = GUIUtil::formatBalance(ucaAvailableBalance, nDisplayUnit);
