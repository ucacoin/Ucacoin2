...
#include "qt/ucacoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ucacoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(UCACoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the UCACoin RPC console.") + "<br>" +
