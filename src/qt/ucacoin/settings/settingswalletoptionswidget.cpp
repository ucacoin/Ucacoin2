...
#include "qt/ucacoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ucacoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(UCACoinGUI* _window, QWidget *parent) :
