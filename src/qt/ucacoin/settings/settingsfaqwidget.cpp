...
#include "qt/ucacoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ucacoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(UCACoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableUCA,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableUCA,
    ...
    connect(ui->pushButton_UnspendableUCA, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableUCA);});
    ...
    if (parent)
        connect(parent, &UCACoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
