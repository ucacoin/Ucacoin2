...
#include "qt/ucacoin/settings/settingsnetworkwidget.h"
#include "qt/ucacoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ucacoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ucacoinGUI* _window, QWidget *parent) :
