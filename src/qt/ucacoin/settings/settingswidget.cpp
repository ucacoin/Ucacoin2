...
#include "qt/ucacoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(UCACoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &UCACoinGUI::openFAQ);
