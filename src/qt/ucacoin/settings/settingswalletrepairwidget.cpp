...
#include "qt/ucacoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ucacoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ucacoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ucacoinGUI::handleRestart()
