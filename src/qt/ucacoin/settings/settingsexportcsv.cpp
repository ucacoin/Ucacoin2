...
#include "qt/ucacoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(UCACoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("UCACoin_tx_csv_export(*.csv)") : tr("UCACoin_addresses_csv_export(*.csv)"),
                                        nullptr);
