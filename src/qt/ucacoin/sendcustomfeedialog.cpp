...
#include "qt/ucacoin/sendcustomfeedialog.h"
#include "qt/ucacoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(UCACoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &UCACoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
