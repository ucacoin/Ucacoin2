...
#include "qt/ucacoin/forms/ui_sendchangeaddressdialog.h"
    ...
    ui(new Ui::SendChangeAddressDialog)
{
    ...
    ui->labelMessage->setText(tr("The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" ucacoin address"));
    ui->labelMessage->setProperty("cssClass", "text-main-grey");

    ui->lineEditAddress->setPlaceholderText("Enter ucacoin address (e.g GMeCEsjP732YA4uvBKR... ");
