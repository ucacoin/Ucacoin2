...
/** Utility functions used by the UCACoin Qt UI.
 */
namespace GUIUtil
{
...
// Render UCACoin addresses in monospace font
...
// Parse "ucacoin:" URI into recipient object, return true on successful parsing
