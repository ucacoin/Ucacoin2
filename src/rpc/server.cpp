...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* UCACoin features */
        {"ucacoin", "listmasternodes", &listmasternodes, true },
        {"ucacoin", "getmasternodecount", &getmasternodecount, true },
        {"ucacoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"ucacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"ucacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"ucacoin", "masternodecurrent", &masternodecurrent, true },
        {"ucacoin", "startmasternode", &startmasternode, true },
        {"ucacoin", "createmasternodekey", &createmasternodekey, true },
        {"ucacoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"ucacoin", "listmasternodeconf", &listmasternodeconf, true },
        {"ucacoin", "getmasternodestatus", &getmasternodestatus, true },
        {"ucacoin", "getmasternodewinners", &getmasternodewinners, true },
        {"ucacoin", "getmasternodescores", &getmasternodescores, true },
        {"ucacoin", "preparebudget", &preparebudget, true },
        {"ucacoin", "submitbudget", &submitbudget, true },
        {"ucacoin", "mnbudgetvote", &mnbudgetvote, true },
        {"ucacoin", "getbudgetvotes", &getbudgetvotes, true },
        {"ucacoin", "getnextsuperblock", &getnextsuperblock, true },
        {"ucacoin", "getbudgetprojection", &getbudgetprojection, true },
        {"ucacoin", "getbudgetinfo", &getbudgetinfo, true },
        {"ucacoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"ucacoin", "mnfinalbudget", &mnfinalbudget, true },
        {"ucacoin", "checkbudgets", &checkbudgets, true },
        {"ucacoin", "mnsync", &mnsync, true },
        {"ucacoin", "spork", &spork, true },
