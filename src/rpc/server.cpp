...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "ucacoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ucacoin features */
        {"ucacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ucacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ucacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ucacoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ucacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ucacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ucacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ucacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ucacoin", "startmasternode", &startmasternode, true, true, false},
        {"ucacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ucacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ucacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ucacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ucacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ucacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ucacoin", "preparebudget", &preparebudget, true, true, false},
        {"ucacoin", "submitbudget", &submitbudget, true, true, false},
        {"ucacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ucacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ucacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ucacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ucacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ucacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ucacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ucacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ucacoin", "mnsync", &mnsync, true, true, false},
        {"ucacoin", "spork", &spork, true, true, false},
        {"ucacoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ucacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33211/\n";
}
