...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("UCACoin ucacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ucacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ucacoin transaction") + "\n" +
                               "  ucacoin-tx [options] -create [commands]   " + _("Create hex-encoded ucacoin transaction") + "\n" +
                               "\n";
...
static CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 21000000000)
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ucacoin transaction
