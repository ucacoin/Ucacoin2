...
"""Verify that starting ucacoin with -h works as expected."""
import subprocess

from test_framework.test_framework import UCACoinTestFramework
from test_framework.util import assert_equal

class HelpTest(UCACoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ucacoin with -? for help text")
        ...
        self.log.info("Start ucacoin with -version for version information")
